...
Honesty (UI52–66): every security-* smoke pins security-policies.remainders=false
...
security.enabled=false and JWT-authed admin paths).
  Shared helper: examples/assert-security-policies-honesty.py (UI63–66; L0 + security-core + extended/cedar).
EOF
}
