...
Honesty (UI52–71): every security-* smoke pins security-policies.remainders=false
...
security.enabled=false and JWT-authed admin paths).
  Shared helper: examples/assert-security-policies-honesty.py (UI63–66).
  Coverage gate: examples/check-honesty-helper-coverage.sh (UI71; 26 smokes).
EOF
}
